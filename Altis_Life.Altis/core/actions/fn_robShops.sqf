...
if(_cops < 2) exitWith{[[_vault,-1],"disableSerialization;",false,false] spawn life_fnc_MP; hint "Il n'y a pas assez de gendarmes!";}; //2 est le nombre de gendarmes necessaire 
...
hBf0MznDHQm7X5DFFSmy = hBf0MznDHQm7X5DFFSmy + _kassa;

_rip = false;
life_use_atm = false;
sleep (150 + random(120));
life_use_atm = true;
if!(alive _robber) exitWith {};
