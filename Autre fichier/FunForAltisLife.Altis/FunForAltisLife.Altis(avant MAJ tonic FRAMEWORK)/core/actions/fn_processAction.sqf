...
_itemInfo = switch (_type) do
{
	...
	case "heroin": {["heroinu","heroinp",20000,(localize "STR_Process_Heroin")];};
	...
	case "cocaine": {["cocaine","cocainep",25000,(localize "STR_Process_Cocaine")];};
	case "marijuana": {["cannabis","marijuana",7500,(localize "STR_Process_Marijuana")];};
	case "cement": {["rock","cement",350,(localize "STR_Process_Cement")];};
	case "raisin": {["raisinu","raisinp",150,(localize "STR_Process_Raisin")];};
	case "raisinaffine": {["raisinp","raisina",250,(localize "STR_Process_RaisinA")];};
	case "meth": {["methu","methp",1500,(localize "STR_Process_Meth")];};
	case "lsd": {["lsdu","lsdp",500,(localize "STR_Process_Lsd")];};
	case "tabac": {["tabacu","tabacp",70,(localize "STR_Process_Tabac")];};
	case "bois": {["bois","bois_r",300,(localize "STR_Process_Bois")];};
	default {[];};
};
...
//Setup vars.
_oldItem = _itemInfo select 0;																//ajouter par William
...
_olditemName = [([_oldItem,0] call life_fnc_varHandle)] call life_fnc_varToStr;				//ajouter par William
