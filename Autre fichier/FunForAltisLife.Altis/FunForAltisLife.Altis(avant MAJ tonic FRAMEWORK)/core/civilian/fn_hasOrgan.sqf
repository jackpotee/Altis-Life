...
if(isNull _organThief) exitWith {}; //if not the thief get bent
	...
	[[1,format["%1 a pris un rein à %2.",name _organThief,name player]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP; //lets people know you are stealing kidneys
	...
	sleep 3600; //no more organ theft for at least 15 minutes, so they cant just do it over and over, can do whatever time you want
