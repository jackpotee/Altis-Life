...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "raisin": {_var = "license_civ_raisin"};
			case "raisinaffine": {_var = "license_civ_raisina"};
			case "rebel1": {_var = "license_civ_rebel1"};
			case "rebel2": {_var = "license_civ_rebel2"};
			case "rebel3": {_var = "license_civ_rebel3"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_raisin": {_var = "raisin"};
			case "license_civ_raisina": {_var = "raisinaffine"};
			case "license_civ_rebel1": {_var = "rebel1"};
			case "license_civ_rebel2": {_var = "rebel2"};
			case "license_civ_rebel3": {_var = "rebel3"};
			default {_var = ""};
		};
	};
};
