...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "piecea": {"life_inv_piecea"};
			case "methu": {"life_inv_methu"};
			case "methp": {"life_inv_methp"};
			case "lsdu": {"life_inv_lsdu"};
			case "lsdp": {"life_inv_lsdp"};
			case "tabacu": {"life_inv_tabacu"};
			case "tabacp": {"life_inv_tabacp"};
			case "raisinu": {"life_inv_raisinu"};
			case "raisinp": {"life_inv_raisinp"};
			case "raisina": {"life_inv_raisina"};
			case "bois": {"life_inv_bois"};
			case "bois_r": {"life_inv_boisr"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_piecea": {"piecea"};
			case "life_inv_methu": {"methu"};
			case "life_inv_methp": {"methp"};
			case "life_inv_lsdu": {"lsdu"};
			case "life_inv_lsdp": {"lsdp"};
			case "life_inv_tabacu": {"tabacu"};
			case "life_inv_tabacp": {"tabacp"};
			case "life_inv_raisinu": {"raisinu"};
			case "life_inv_raisinp": {"raisinp"};
			case "life_inv_raisina": {"raisina"};
			case "life_inv_bois": {"bois"};
			case "life_inv_boisr": {"bois_r"};
