...
switch (_shop) do
{
	case "market": {["Marché d'Altis",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","hache","fuelF","peach","storagesmall","storagebig","battery","tabacp","raisinp","raisina"]]};
