...
if((lbCurSel 2005) == -1) exitWith {hint "Tu n'as pas selectionné d'objet à donner.";ctrlShow[2002,true];};
...
if(!([_val] call TON_fnc_isnumber)) exitWith {hint "Tu n'as pas entré un nombre valide.";ctrlShow[2002,true];};
