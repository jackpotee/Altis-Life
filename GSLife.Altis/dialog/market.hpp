...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Bourse d'Altis Life</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1000;
			text = "Matière première"; //--- ToDo: Localize;
		...
		{
			idc = 1101;
			text = "<t align='center'>Evolution du marché</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
