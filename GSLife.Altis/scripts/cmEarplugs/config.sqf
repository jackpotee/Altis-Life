...
cmManMuteMessage = {
hint "Tu as inséré les bouchons d'oreilles.";
...
cmManReturnSoundMsg = {
hint "Tu as retiré les bouchons d'oreilles.";
...
cmReturnSoundMsg = {
hint "Les bouchons d'oreilles ont été retiré automatiquement.";
	...
	while {true} do {
		...
		waitUntil {uisleep 0.5; vehicle player != player};
			...
			if (_checkington == "hasNoMenu") then {
				_null = _cm_whatImInATM addaction ["<img image='scripts\cmEarplugs\earplugs.paa' /><t color=""#38eeff""> Bouchons d'oreilles</t>","[] call cm_Earplugs_FUNc","",0,false,false,"","[] call EP_req_1"];							
