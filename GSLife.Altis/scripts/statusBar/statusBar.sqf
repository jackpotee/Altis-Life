...
//	systemChat format["StatusBar Initialized", _rscLayer];
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			format["
			<t shadow='1' shadowColor='#000000' color='%08'><img size='1.6'  shadowColor='#000000' image='scripts\statusbar\icons\logo.paa' color='%08'/> GhostSquad Life v3.1.4.8</t>
			<t shadow='1' shadowColor='#000000' color='%08'><img size='1.6'  shadowColor='#000000' image='scripts\statusbar\icons\players.paa' color='%08'/> %2</t>
			<t shadow='1' shadowColor='#000000' color='%09'><img size='1.0'  shadowColor='#000000' image='scripts\statusbar\icons\health.paa' color='%09'/> %3%1</t>  
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='scripts\statusbar\icons\hunger.paa' color='%10'/> %4%1</t> 
			<t shadow='1' shadowColor='#000000' color='%11'><img size='1.6'  shadowColor='#000000' image='scripts\statusbar\icons\thirst.paa' color='%11'/> %5%1</t>
			<t shadow='1' shadowColor='#000000' color='%08'><img size='1.6'  shadowColor='#000000' image='scripts\statusbar\icons\batterie.paa' color='%08'/> %17</t>
			<t shadow='1' shadowColor='#000000' color='%08'>FPS: %6</t>
			<t shadow='1' shadowColor='#000000' color='%07'><img size='1.6'  shadowColor='#000000' image='scripts\statusbar\icons\restart.paa' color='%08'/>%15:%16</t>",
